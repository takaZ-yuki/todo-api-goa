...
func main() {
	...
	var (
		userControllerEndpoints *usercontroller.Endpoints
	)
	{
		userControllerEndpoints = usercontroller.NewEndpoints(userControllerSvc)
	}
	...
	case "localhost":
		{
			...
			handleHTTPServer(ctx, u, userControllerEndpoints, &wg, errc, logger, *dbgF)
		}
